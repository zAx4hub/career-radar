...
> Job search CRM + skill gaps

**Author:** zAx4hub

## Problem

Teams need a practical open toolkit for: **Job search CRM + skill gaps**. Existing options are often closed SaaS or untested prototypes.

## Solution

`career-radar` is a complete, installable Python project by **zAx4hub** with real algorithms, CLI/demos, tests, and CI.
...
py -m pytest -q
py -m career_radar.cli demo
```

## Features

- Core engine for job search crm + skill gaps
